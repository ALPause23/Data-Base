...
(
	...
	build_time TIME(4),
	CONSTRAINT product_pk0 PRIMARY KEY (type)
);
...
(
	...
	id_otk int,
	result char(50),
	CONSTRAINT manufacture_pk0 PRIMARY KEY (id_workshop, id_shift, type)
);
...
ALTER TABLE manufacture ADD CONSTRAINT manufacture_fk2 FOREIGN KEY (type) REFERENCES product(type) ON DELETE CASCADE ON UPDATE CASCADE;
...
INSERT INTO product (type, build_time) VALUES ('Изделие 1', '00:20:56'),
											  ('Изделие 2', '10:20:56'),
											  ('Изделие 3', '02:27:56'),
											  ('Изделие 4', '03:23:56'),
											  ('Изделие 5', '00:34:56'),
											  ...
											  ('Изделие 7', '06:50:56'),
                                              ('Документы', '01:30:00');
INSERT INTO manufacture (id_workshop, id_shift, type, id_otk, result) VALUES (1, 1, 'Изделие 1', 7, 'Брак отсутствует'),
																			 (1, 2, 'Изделие 1', 90, 'Брак отсутствует'),
                                                                             (1, 3, 'Изделие 1', 7, 'Брак отсутствует'),
                                                                             (2, 1, 'Изделие 2', 7, 'Брак отсутствует'),
                                                                             (2, 2, 'Изделие 1', 2, 'Брак отсутствует'),
                                                                             (2, 3, 'Изделие 7', 7, 'Брак 19 шт.'),
                                                                             (3, 1, 'Изделие 3', 1, 'Брак 1 шт.'),
                                                                             (3, 2, 'Изделие 2', 7, 'Брак отсутствует'),
                                                                             (3, 4, 'Изделие 3', 1, 'Брак 3 шт.'),
                                                                             (4, 1, 'Документы', NULL, 'Документы заполнены');
